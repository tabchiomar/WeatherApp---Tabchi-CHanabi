...
final Map<String, String> arAR = {
  ...
  Strings.welcomScreenTitle:
      'استكشف الخريطة العالمية لظروف الرياح والطقس والمحيطات',
  Strings.welcomScreenSubtitle:
      'يصبح التخطيط لرحلتك أسهل مع تطبيق الطقس المثالي. يمكنك رؤية كلمة الطقس بأكملها على الفور في غضون ثوانٍ قليلة',
  Strings.getStarted: 'البدء',
  Strings.alreadyHaveAnAccount: 'هل لديك حساب؟ ',
  Strings.login: 'تسجيل الدخول',
  Strings.helloUser: 'مرحباً ',
  ...
  Strings.pleaseEnableLocationPermission:
      'يرجى تمكين إذن الموقع للحصول على معلومات أكثر دقة عن الطقس',
