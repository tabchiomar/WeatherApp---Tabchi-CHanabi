                ...
                children: [
                  ...
                  AspectRatio(
                    ...
                    child: PageView.builder(
                      ...
                      itemCount:
                          controller.weatherDetails.forecast.forecastday.length,
                        ...
                        return AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            ...
                            if (controller
                              ...
                              if (index == 1)
                                value = controller.isEnLang ? 0.038 : -0.038;
                              if (index == 2)
                                value = controller.isEnLang ? -0.038 : 0.038;
                            }
                          ...
                          child: Row(
                            children: [
                              WeatherDetailsItem(
                                ...
                                icon: Constants.wind,
                                value: controller.weatherDetails.current.windMph
                                    .toInt()
                                    .toString(),
                                text: 'mph',
                              ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Container(
                                padding:
                                    EdgeInsets.fromLTRB(15.w, 15.h, 15.w, 10.h),
                                decoration: BoxDecoration(
                                  color: theme.cardColor,
                                  borderRadius: BorderRadius.circular(20.r),
                                ),
