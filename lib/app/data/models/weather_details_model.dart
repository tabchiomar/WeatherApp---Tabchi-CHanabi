...
class Astro {
  ...
  factory Astro.fromJson(Map<String, dynamic> json) => Astro(
        sunrise: json['sunrise']?.toString() ?? 'N/A', // Convert to String
        sunset: json['sunset']?.toString() ?? 'N/A',
        moonrise: json['moonrise']?.toString() ?? 'N/A',
        moonset: json['moonset']?.toString() ?? 'N/A',
        moonPhase: json['moon_phase'] ?? 'Unknown',
        moonIllumination: json['moon_illumination']?.toString() ?? '0',
